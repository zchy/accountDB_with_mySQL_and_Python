    ...
    try:
        ...
        if len(matches) != 0:
            ...
            sql2 = ("CREATE TABLE IF NOT EXISTS " + (lis[0]) +
                  ...
                  " date DATE NOT NULL, income FLOAT NOT NULL, tax FLOAT NOT NULL,"+
                  " PRIMARY KEY (date));")
            cur.execute(sql2)
            ...
            messagebox.showwarning("Invalid inputs or ERROR!!")
...
l5 = tk.Label(leftSide, text ="Tax: ", font=('times', 25, 'bold'), 
              bg = "#00FF7F", fg = "#046666")
