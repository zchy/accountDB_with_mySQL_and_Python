...
def make_summary_html(table):
    ...
    summary_report = ("<h1 style='background-color:#f9b3b3;'>" + table.upper() +"</h1><h1>Sales Summary: </h1><h3>Gross Escrow Account Balance(total tax): " + str(tx)+
                      "<br> Net Escrow Account Balance(balance after taxes): "+ str(total_taxes_owe) +
                      "<br> Total sales tax generated: " + str(tx)+   
                      "<br>Total Expenses: " + str(expns)+
                      "<br>Gross Buisness Account Balance(before expenses): " + str(balance_before_expenses) +
                      "<br> Net Buisness Account Balance(after expenses): " + str(balance_after_expenses) +
                      "<br></h3>")
    
    
    NY_summary_report = ("<h1>NY Sales Summary:</h1><h3> Total sales tax owed to NY: " + str(NY_tax)+
                         "<br>Total Taxes will Pay or Paid to NY: " + str(total_taxes_pay_paid_to_NY)+
                         "<br>Total Sales in NY: " + str(total_sales_in_NY) + "</h3>")
    
    NJ_summary_report = ("<h1>NJ Sales Summary:</h1><h3> Total sales tax owed to NJ: " + str(NJ_tax)+
                         "<br>Total Taxes will Pay or Paid to NJ: " + str(total_taxes_pay_paid_to_NJ)+
                         "<br>Total Sales in NJ: " + str(total_sales_in_NJ) + "</h3>")
        
    CT_summary_report = ("<h1>CT Sales Summary:</h1><h3> Total sales tax owed to CT: " + str(CT_tax)+
                         "<br>Total Taxes will Pay or Paid to CT: " + str(total_taxes_pay_paid_to_CT)+
                         "<br>Total Sales in CT: " + str(total_sales_in_CT) + "</h3>")
            
    Chicago_summary_report = ("<h1>Chicago/IL Sales Summary:</h1><h3> Total sales tax owed to Chicago/IL: " + str(Chicago_tax)+
                         "<br>Total Taxes will Pay or Paid to Chicago/IL: " + str(total_taxes_pay_paid_to_Chicago)+
                         "<br>Total Sales in Chicago/IL: " + str(total_sales_in_Chicago) + "</h3>")
